...
// KeyT - is a key type. It must be comporable and ordered.
...
// This is actualy the same as NewAVLTree but Comparator will be defined automaticaly inside the call.
